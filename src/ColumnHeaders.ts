...
export const ColumnHeadersBase = ThemeableMixin(WidgetBase);

export interface ColumnHeadersProperties extends ThemeableProperties, HasColumns, HasSortDetails, HasSortEvent {}
